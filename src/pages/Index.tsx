            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              ...
              <div className="lg:col-span-2">
                ...
                {/* <div className="flex gap-4">
                  <a href="mailto:sahanbhasima132@gmail.com" className="w-10 h-10 bg-cyber-electric/20 hover:bg-cyber-electric/30 rounded-lg flex items-center justify-center transition-colors">
